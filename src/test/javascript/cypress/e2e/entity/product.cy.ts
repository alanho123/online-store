...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'physically until boon', price: 29737.23, productSize: 'M' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('golden lifetime vice');
      cy.get(`[data-cy="name"]`).should('have.value', 'golden lifetime vice');

      cy.get(`[data-cy="description"]`).type('keenly indeed');
      cy.get(`[data-cy="description"]`).should('have.value', 'keenly indeed');

      cy.get(`[data-cy="price"]`).type('3629.41');
      cy.get(`[data-cy="price"]`).should('have.value', '3629.41');
