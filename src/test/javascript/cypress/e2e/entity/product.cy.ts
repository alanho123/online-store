...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'oof externalize stormy', price: 19977.77, productSize: 'M' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('seldom hmph');
      cy.get(`[data-cy="name"]`).should('have.value', 'seldom hmph');

      cy.get(`[data-cy="description"]`).type('resent teepee fast');
      cy.get(`[data-cy="description"]`).should('have.value', 'resent teepee fast');

      cy.get(`[data-cy="price"]`).type('324.47');
      cy.get(`[data-cy="price"]`).should('have.value', '324.47');
