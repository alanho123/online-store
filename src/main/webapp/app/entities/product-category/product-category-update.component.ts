      ...
      if (this.productCategory.id) {
        this.productCategoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('storeApp.productCategory.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.productCategoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('storeApp.productCategory.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
