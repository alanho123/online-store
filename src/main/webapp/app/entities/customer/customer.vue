  ...
  <div>
      ...
      <table class="table table-striped" aria-describedby="customers">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('firstName')">
              <span v-text="t$('storeApp.customer.firstName')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('lastName')">
              <span v-text="t$('storeApp.customer.lastName')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('gender')">
              <span v-text="t$('storeApp.customer.gender')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('email')">
              <span v-text="t$('storeApp.customer.email')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'email'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('phone')">
              <span v-text="t$('storeApp.customer.phone')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('addressLine1')">
              <span v-text="t$('storeApp.customer.addressLine1')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('addressLine2')">
              <span v-text="t$('storeApp.customer.addressLine2')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('city')">
              <span v-text="t$('storeApp.customer.city')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('country')">
              <span v-text="t$('storeApp.customer.country')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('user.login')">
              <span v-text="t$('storeApp.customer.user')"></span>
        ...
        <tbody>
          <tr v-for="customer in customers" :key="customer.id" data-cy="entityTable">
            ...
            <td v-text="t$('storeApp.Gender.' + customer.gender)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      ...
      <div class="modal-body">
        <p id="jhi-delete-customer-heading" v-text="t$('storeApp.customer.delete.question', { id: removeId })"></p>
      </div>
